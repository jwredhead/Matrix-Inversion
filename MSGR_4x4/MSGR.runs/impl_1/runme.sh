...
HD_PWD='D:/Vivado_Projects/MSGR/MSGR.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Overall_MSGR.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Overall_MSGR.tcl -notrace
