...
HD_PWD='D:/Vivado_Projects/MSGR/MSGR.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Overall_MSGR.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Overall_MSGR.tcl
