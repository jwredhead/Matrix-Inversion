...
HD_PWD='D:/Vivado_Projects/MSGR/MSGR.runs/FP_DIVIDE_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FP_DIVIDE.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FP_DIVIDE.tcl
