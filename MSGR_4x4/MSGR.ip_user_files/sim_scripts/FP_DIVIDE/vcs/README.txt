...
#
# Generated by export_simulation on Wed Apr 03 18:03:15 -0500 2019
#
################################################################################
...
'-reset_run' switch to the './FP_DIVIDE.sh' script.

./FP_DIVIDE.sh -reset_run
...
./FP_DIVIDE.sh -noclean_files

For more information on the script, please type './FP_DIVIDE.sh -help'.
