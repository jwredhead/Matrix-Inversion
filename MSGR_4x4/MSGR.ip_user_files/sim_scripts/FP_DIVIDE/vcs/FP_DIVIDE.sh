...
#
# Generated by Vivado on Wed Apr 03 18:03:15 -0500 2019
# SW Build 2405991 on Thu Dec  6 23:38:27 MST 2018
#
# Copyright 1986-2018 Xilinx, Inc. All Rights Reserved. 
#
# usage: FP_DIVIDE.sh [-help]
# usage: FP_DIVIDE.sh [-lib_map_path]
# usage: FP_DIVIDE.sh [-noclean_files]
# usage: FP_DIVIDE.sh [-reset_run]
#
...
# executing this script. Please type 'FP_DIVIDE.sh -help' for more information.
#
...
# Script info
echo -e "FP_DIVIDE.sh - Script generated by export_simulation (Vivado v2018.3 (64-bit)-id)\n"
...
compile()
{
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../../MSGR.srcs/sources_1/ip/FP_DIVIDE/sim/FP_DIVIDE.vhd" \
  2>&1 | tee -a vhdlan.log
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.FP_DIVIDE -o FP_DIVIDE_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./FP_DIVIDE_simv $vcs_sim_opts -do simulate.do
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./FP_DIVIDE.sh -help\" for more information)\n"
        exit 1
      fi
...
reset_run()
{
  files_to_remove=(ucli.key FP_DIVIDE_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc FP_DIVIDE_simv.daidir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./FP_DIVIDE.sh -help\" for more information)\n"
    exit 1
  fi
